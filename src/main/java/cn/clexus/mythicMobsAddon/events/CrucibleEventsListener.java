...
public class CrucibleEventsListener implements Listener {
    ...
    public void onPlayerInput(PlayerInputEvent event) {
        ...
        Collection<SkillMechanic> mechanics = getAllMechanics(player, OnPlayerInputTrigger.onPlayerInput);
        TriggeredSkill ts = new TriggeredSkill(OnPlayerInputTrigger.onPlayerInput, playerData, BukkitAdapter.adapt(player.getLocation()), new BukkitPlayer(event.getPlayer()), mechanics, true);
    }
