...
public class RemovePDCMechanic extends SkillMechanic implements ITargetedEntitySkill {
    private final String slot;
    private final NamespacedKey namespacedKey;

    public RemovePDCMechanic(SkillExecutor manager, File file, String line, MythicLineConfig mlc) {
        ...
        if(namespacedKey == null){
            ...
            if(locale.equals(Locale.CHINA)){
                MythicLogger.errorMechanicConfig(this, mlc,"removePDC技能中的namespacedKey参数格式有误");
            }else{
    ...
    public SkillResult castAtEntity(SkillMetadata skillMetadata, AbstractEntity abstractEntity) {
        ...
        itemStack.editMeta(meta -> meta.getPersistentDataContainer().remove(namespacedKey));
